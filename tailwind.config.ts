  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'orbit-4': 'orbit 15s linear infinite reverse',
        'orbit-5': 'orbit 35s linear infinite',
        'carousel-scroll': 'carouselScroll 8s linear infinite',
      },
      keyframes: {
        fadeIn: {
          '0%': { opacity: '0' },
        ...
        phoneScroll: {
          ...
          '35%, 50%': { transform: 'translateY(-25%)' },
          '70%, 85%': { transform: 'translateY(-50%)' },
